      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl relative z-10">
        ...
        >
            ...
            >
              ...
              <div>
                <p className="text-amber-300 font-medium">
                  The following {alreadyParsedFiles.length === 1 ? 'resume' : 'resumes'} {alreadyParsedFiles.length === 1 ? 'has' : 'have'} already been parsed and stored in the database:
                </p>
          ...
          <div className="space-y-6">
            ...
            {activeTab === 'uploaded' && files.map((file, index) => (
              <motion.div 
                key={index} 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="flex items-center space-x-4">
                  <FileIcon className={`w-6 h-6 ${alreadyParsedFiles.includes(file.name) ? 'text-amber-500' : 'text-blue-500'}`} />
                  <div>
